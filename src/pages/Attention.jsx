    ...
    <Layout style={{backgroundColor: 'blue'}}>
      ...
      <div className={styles.box} style={{marginTop: '35px', height: '1410px', padding: '20px'}}>
        ...
        <>
          ...
          <div style={{marginTop: '15px', marginLeft: '10px', marginRight: '10px', fontSize: '0.85em', fontWeight: '500'}}>
            <div>미등기 상태의 매물입니다.</div>
            <div style={{marginTop: '10px'}}>따라서 분양 계약서, 키불출 확인서와 같은 <br/>서류를 통해 소유자를 확인해야 해요!</div>
        ...
        <>
          ...
          <div style={{marginTop: '15px', marginLeft: '10px', marginRight: '10px', fontSize: '0.85em', fontWeight: '500'}}>
            <div>'전세보증금 잔금 전 또는 보증금을 받는 즉시 집주인이 분양 잔금을 완납하지 않으면 전세 <br/> 계약을 해지한다' 라는 내용의 특약사항을 넣으시길 추천드려요.</div>
          </div>
        </>
        ...
        <>
          ...
          <div style={{marginTop: '15px', marginLeft: '10px', marginRight: '10px', fontSize: '0.85em', fontWeight: '500'}}>
            <div>공급 계약서나 분양 계약서상 소유자와 현재 <br/> 임대인이 같은 사람인지를 꼭 확인해야 합니다.</div>
